...
namespace AzureFunctionsCustomBindingSample.DocumentPersistence
{
  ...
  /// <summary>Provides a simple API to persistence of documents that inherits the <see cref="AzureFunctionsCustomBindingSample.DocumentPersistence.DocumentBase"/> class.</summary>
