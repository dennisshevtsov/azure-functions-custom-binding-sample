...
namespace AzureFunctionsCustomBindingSample.Api.QueryHandlers
{
  ...
  public sealed class GetTodoListQueryHandler : IQueryHandler<GetTodoListRequestDto, TodoListDocument>
  {
    ...
    /// <summary>Initializes a new instance of the <see cref="AzureFunctionsCustomBindingSample.Api.QueryHandlers.GetTodoListQueryHandler"/> class.</summary>
    ...
    public GetTodoListQueryHandler(IDocumentClient documentClient)
