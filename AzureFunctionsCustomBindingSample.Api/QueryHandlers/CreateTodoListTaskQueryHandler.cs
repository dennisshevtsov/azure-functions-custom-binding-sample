...
namespace AzureFunctionsCustomBindingSample.Api.QueryHandlers
{
  ...
  public sealed class CreateTodoListTaskQueryHandler : IQueryHandler<CreateTodoListTaskRequestDto, TodoListDocument>
  {
    private readonly IDocumentClient _documentClient;

    /// <summary>Initializes a new instance of the <see cref="AzureFunctionsCustomBindingSample.Api.QueryHandlers.CreateTodoListTaskQueryHandler"/> class.</summary>
    ...
    public CreateTodoListTaskQueryHandler(IDocumentClient documentClient)
    ...
    public Task<TodoListDocument> HandleAsync(CreateTodoListTaskRequestDto query, CancellationToken cancellationToken)
