...
namespace AzureFunctionsCustomBindingSample.Api.QueryHandlers
{
  ...
  public sealed class CreateTodoListTaskQueryHandler : IQueryHandler<CreateTodoListTaskRequestDto>
  {
    ...
    public Task<object> HandleAsync(CreateTodoListTaskRequestDto query, CancellationToken cancellationToken)
