...
namespace AzureFunctionsCustomBindingSample.Api.QueryHandlers
{
  ...
  public sealed class GetTodoListTaskQueryHandler : IQueryHandler<GetTodoListTaskRequestDto, TodoListDocument>
  {
    private readonly IDocumentClient _documentClient;

    /// <summary>Initializes a new instance of the <see cref="AzureFunctionsCustomBindingSample.Api.QueryHandlers.GetTodoListTaskQueryHandler"/> class.</summary>
    ...
    public GetTodoListTaskQueryHandler(IDocumentClient documentClient)
    ...
    public Task<TodoListDocument> HandleAsync(GetTodoListTaskRequestDto query, CancellationToken cancellationToken)
