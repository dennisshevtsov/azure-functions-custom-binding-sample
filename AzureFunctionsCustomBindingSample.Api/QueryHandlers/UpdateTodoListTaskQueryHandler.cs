...
namespace AzureFunctionsCustomBindingSample.Api.QueryHandlers
{
  ...
  public sealed class UpdateTodoListTaskQueryHandler : IQueryHandler<UpdateTodoListTaskRequestDto, TodoListDocument>
  {
    ...
    public Task<TodoListDocument> HandleAsync(UpdateTodoListTaskRequestDto query, CancellationToken cancellationToken)
