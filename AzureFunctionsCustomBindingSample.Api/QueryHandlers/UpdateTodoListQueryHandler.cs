...
namespace AzureFunctionsCustomBindingSample.Api.QueryHandlers
{
  ...
  public sealed class UpdateTodoListQueryHandler : IQueryHandler<UpdateTodoListRequestDto, TodoListDocument>
  {
    private readonly IDocumentClient _documentClient;

    /// <summary>Initializes a new instance of the <see cref="AzureFunctionsCustomBindingSample.Api.QueryHandlers.UpdateTodoListQueryHandler"/> class.</summary>
    ...
    public Task<TodoListDocument> HandleAsync(UpdateTodoListRequestDto query, CancellationToken cancellationToken)
