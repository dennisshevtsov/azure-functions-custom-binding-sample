...
namespace AzureFunctionsCustomBindingSample.Api.Binding.Service
{
  ...
  /// <summary>Binds the <see cref="AzureFunctionsCustomBindingSample.Api.Binding.Service.ServiceValueProvider"/> with a parameter that is marked with the <see cref="AzureFunctionsCustomBindingSample.Api.Binding.ServiceAttribute"/> attribute.</summary>
