...
namespace AzureFunctionsCustomBindingSample.Api.Binding.Request
{
  ...
  /// <summary>Binds the <see cref="AzureFunctionsCustomBindingSample.Api.Binding.Request.RequestValueProvider"/> with a parameter that is marked with the <see cref="AzureFunctionsCustomBindingSample.Api.Binding.RequestAttribute"/> attribute.</summary>
