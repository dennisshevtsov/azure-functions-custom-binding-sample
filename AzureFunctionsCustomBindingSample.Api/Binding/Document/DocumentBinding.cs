...
namespace AzureFunctionsCustomBindingSample.Api.Binding.Document
{
  ...
  /// <summary>Binds the <see cref="AzureFunctionsCustomBindingSample.Api.Binding.Document.DocumentValueProvider"/> with a parameter that is marked with the <see cref="AzureFunctionsCustomBindingSample.Api.Binding.DocumentAttribute"/> attribute.</summary>
  public sealed class DocumentBinding : IBinding
  {
    ...
    /// <summary>Initializes a new instance of the <see cref="DocumentBinding"/> class.</summary>
